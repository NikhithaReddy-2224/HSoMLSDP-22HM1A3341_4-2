...
const Analytics = () => {
  ...
  const datasetPerformance = [
    { dataset: 'CM1', accuracy: 82.5, precision: 80.3, recall: 78.7, f1Score: 79.5 },
    { dataset: 'KC1', accuracy: 84.2, precision: 83.1, recall: 81.8, f1Score: 82.4 },
    { dataset: 'KC4', accuracy: 81.8, precision: 89.6, recall: 80.2, f1Score: 80.9 },
    { dataset: 'PC3', accuracy: 83.6, precision: 82.4, recall: 81.1, f1Score: 81.7 },
    { dataset: 'PC5', accuracy: 85.1, precision: 84.3, recall: 83.8, f1Score: 84.0 },
  ];
        ...
        <Card className="p-6">
          ...
          <div className="space-y-3 text-muted-foreground">
            <p className="flex items-start gap-2">
              ...
              The Stacking Classifier achieves the highest accuracy at 85.8%, demonstrating the power of ensemble learning.
            </p>
            <p className="flex items-start gap-2">
              <span className="text-primary">•</span>
              Dataset PC5 shows the best overall performance with 85.1% accuracy across all metrics.
            </p>
            <p className="flex items-start gap-2">
              <span className="text-primary">•</span>
